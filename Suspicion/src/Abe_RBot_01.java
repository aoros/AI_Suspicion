...
/**
 * This class uses the guest appearance count for the suspect reporting at the
 * end of the game. Also added the method to remove guest names from the
 * possible suspects when the "peek at deck" action card is played.
 *
 * @author Abraham Oros
 */
public class Abe_RBot_01 extends Bot {
    ...
    public String reportGuesses() {
        ...
        for (String k : players.keySet()) {
            ...
            rval += k;
            rval += "," + getGuessBasedOnCountOfAppearances(p);
            rval += ":";
        }
        return rval.substring(0, rval.length() - 1);
    }

    private String getGuessBasedOnCountOfAppearances(Player player) {
        String guess = "";
    ...
    public Abe_RBot_01(String playerName, String guestName, int numStartingGems, String gemLocations, String[] playerNames, String[] guestNames) {

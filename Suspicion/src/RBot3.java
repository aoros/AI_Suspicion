 ...
 *
 */
public class RBot3 extends Bot {
    ...
    public RBot3(String playerName, String guestName, int numStartingGems, String gemLocations, String[] playerNames, String[] guestNames) {

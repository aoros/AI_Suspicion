...
public abstract class Bot {
    ...
    /**
     * The game calls this method when it is your turn to get the actions you
     * want to perform
     *
     ...
     * The first action in the action string should be the move corresponding to
     * dice 1. The second action should be the move corresponding to dice 2. The
     * third action should the the card you are going to play. The 4th and 5th
     * action should be actions from the card, in any order. Each action should
     * be separated by a colon :. Move action syntax: move,player_name,x,y Play
     * card syntax: play,card1|card2 Card action syntax: * move,guest_name,x,y *
     * viewDeck * ask,guest,player (can player see guest) * get,red|green|yellow
     *
     * Example getPlayerActions("Earl of Volesworthy", "?", "get,:viewDeck",
     * "get,yellow:ask,Remy La Rocque", "Stefano Laconi,Trudie Mudge::Lily
     * Nesbitt::Remy La Rocque:Dr. Ashraf Najem,Buford Barnswallow:::::Viola
     * Chung:Nadia Bwalya,Mildred Wellington,Earl of Volesworthy") return value
     * of action: "move,Earl of Volesworthy,1,3:move,Buford
     * Barnswallow,1,2:play,card1:viewDeck:get,yellow"
     */
    ...
    /**
     * The game calls this method to inform you about the actions that each
     * player takes
     *
    ...
    /**
     * The game calls this method to inform you who is the named player on the
     * top of the deck of NPC cards
     *
     * @param player
     */
    ...
    /**
     *
     * @return a string with your best guesses for each player. Format of string
     * is player1Name,guest1Name:player2Name,guest2Name...
     */

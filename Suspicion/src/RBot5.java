 ...
 *
 */
public class RBot5 extends Bot {
    ...
    public RBot5(String playerName, String guestName, int numStartingGems, String gemLocations, String[] playerNames, String[] guestNames) {
